...
'''
Data Transformation related constant variable
'''
...
'''KNN Imputer related constant variable'''
...
'''
Model Trainer related constant variable
'''
...
MODEL_TRAINING_OVER_FIITING_UNDER_FITTING_THRESHOLD: float = 0.05
MODEL_TRAINER_OVER_FITTING_UNDER_FITTING_THRESHOLD: float = MODEL_TRAINING_OVER_FIITING_UNDER_FITTING_THRESHOLD
